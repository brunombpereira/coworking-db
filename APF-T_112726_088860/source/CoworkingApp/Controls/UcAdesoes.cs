...
namespace CoworkingApp.Controls
{
    public class UcAdesoes : UserControl
    {
        ...
        private void BuildUI()
        {
            ...
            root.RowStyles.Add(new RowStyle(SizeType.Absolute, Theme.RowHeightTitle));
            root.RowStyles.Add(new RowStyle(SizeType.Absolute, Theme.RowHeightToolbar));
            root.RowStyles.Add(new RowStyle(SizeType.Absolute, Theme.RowHeightKpis));
