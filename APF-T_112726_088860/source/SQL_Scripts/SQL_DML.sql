...
('Sala Criativa', 6,  18.00, 'Disponivel',  1),
('Sala Podcast',  4,  20.00, 'Manutencao',  1),
-- CoWork Porto (espaco_id=2)
('Sala Norte',    6,  12.00, 'Disponivel',  2),
('Sala Sul',     10,  18.00, 'Disponivel',  2),
('Sala Executiva',8,  25.00, 'Disponivel',  2),
-- SpaceLab (espaco_id=3)
('Sala Única',    4,  10.00, 'Disponivel',  3),
('Sala Lab',     12,  22.00, 'Disponivel',  3);
GO
...
('HUB-F03', 'Flex',    3.00, 'Disponivel', 1),
('HUB-X01', 'Fixo',    5.00, 'Disponivel', 1),
('HUB-X02', 'Fixo',    5.00, 'Disponivel', 1),
('HUB-P01', 'Privado', 8.00, 'Disponivel', 1),
-- CoWork Porto
('CP-F01',  'Flex',    3.50, 'Disponivel', 2),
('CP-F02',  'Flex',    3.50, 'Disponivel', 2),
('CP-X01',  'Fixo',    5.50, 'Disponivel', 2),
('CP-P01',  'Privado', 8.00, 'Disponivel', 2),
('CP-P02',  'Privado', 8.00, 'Inativo',    2),
-- SpaceLab
('SL-F01',  'Flex',    2.50, 'Disponivel', 3),
('SL-F02',  'Flex',    2.50, 'Disponivel', 3),
('SL-X01',  'Fixo',    4.50, 'Disponivel', 3);
GO
...
('Joana Pereira',      '012345679', 'joana.p@email.pt',        '912000010'),
...
-- =====================================================================
-- Clientes com adesão Ativa (1 por cliente)
...
-- =====================================================================
-- Reservas — inserir uma a uma (triggers T1/T2/T3/T6)
-- Datas futuras e passadas para o dashboard / relatórios ficarem ricos
-- =====================================================================
...
VALUES (1, 1, NULL, '2026-05-06', '09:00', '11:00', 'Confirmada', 30.00, 3, 'Reunião de projeto');
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (2, NULL, 1, '2026-05-06', '08:00', '17:00', 'Confirmada', 27.00, NULL, 'Posto flex dia inteiro');
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (5, NULL, 7, '2026-05-06', '09:00', '13:00', 'Confirmada', 14.00, NULL, NULL);
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (6, 2, NULL, '2026-05-07', '14:00', '17:00', 'Confirmada', 90.00, 12, 'Workshop design');
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (7, 5, NULL, '2026-05-07', '10:00', '12:00', 'Pendente', 24.00, 4, NULL);
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (9, NULL, 12, '2026-05-08', '09:00', '18:00', 'Confirmada', 22.50, NULL, NULL);
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (10, 3, NULL, '2026-05-08', '11:00', '13:00', 'Confirmada', 36.00, 5, 'Apresentação cliente');
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (11, NULL, 6, '2026-05-09', '08:00', '17:00', 'Confirmada', 64.00, NULL, 'Posto privado semana');
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (13, 7, NULL, '2026-05-09', '09:00', '12:00', 'Pendente', 75.00, 6, 'Entrevistas');
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (15, 1, NULL, '2026-05-12', '10:00', '12:00', 'Confirmada', 30.00, 3, NULL);
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (17, NULL, 4, '2026-05-12', '09:00', '14:00', 'Confirmada', 25.00, NULL, NULL);
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (1, 3, NULL, '2026-05-13', '14:00', '16:00', 'Pendente', 36.00, 4, 'Demo produto');
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (6, NULL, 9, '2026-05-14', '08:00', '17:00', 'Confirmada', 49.50, NULL, NULL);
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (4, 6, NULL, '2026-05-15', '13:00', '15:00', 'Confirmada', 36.00, 8, 'Formação interna');
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (19, NULL, 13, '2026-05-15', '09:00', '13:00', 'Pendente', 10.00, NULL, NULL);
GO
-- Canceladas (para histórico)
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (3, 1, NULL, '2026-05-06', '13:00', '15:00', 'Cancelada', 30.00, 2, NULL);
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (8, 5, NULL, '2026-05-08', '14:00', '16:00', 'Cancelada', 24.00, 3, NULL);
GO

-- === Abril 2026 — reservas passadas (Concluidas) ===
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (1, 1, NULL, '2026-04-10', '09:00', '11:00', 'Concluida', 30.00, 3, NULL);
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (2, NULL, 2, '2026-04-10', '08:00', '17:00', 'Concluida', 27.00, NULL, NULL);
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (5, 2, NULL, '2026-04-11', '14:00', '17:00', 'Concluida', 90.00, 10, 'Reunião trimestral');
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (6, NULL, 6, '2026-04-14', '08:00', '17:00', 'Concluida', 64.00, NULL, NULL);
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (10, 3, NULL, '2026-04-15', '10:00', '12:00', 'Concluida', 36.00, 5, NULL);
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (11, NULL, 4, '2026-04-16', '09:00', '13:00', 'Concluida', 20.00, NULL, NULL);
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (7, 6, NULL, '2026-04-17', '13:00', '15:00', 'Concluida', 36.00, 7, NULL);
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (9, NULL, 12, '2026-04-21', '09:00', '17:00', 'Concluida', 20.00, NULL, NULL);
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (13, 7, NULL, '2026-04-22', '09:00', '12:00', 'Concluida', 75.00, 6, NULL);
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (15, NULL, 10, '2026-04-24', '08:00', '17:00', 'Concluida', 64.00, NULL, NULL);
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (17, 5, NULL, '2026-04-25', '11:00', '13:00', 'Concluida', 24.00, 4, NULL);
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (2, 2, NULL, '2026-04-28', '14:00', '18:00', 'Concluida', 120.00, 18, 'Evento comunidade');
GO

-- === Março 2026 — reservas passadas ===
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (6, 2, NULL, '2026-03-05', '09:00', '12:00', 'Concluida', 90.00, 15, 'Hackathon');
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (11, NULL, 6, '2026-03-10', '08:00', '17:00', 'Concluida', 64.00, NULL, NULL);
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (5, 3, NULL, '2026-03-12', '14:00', '16:00', 'Concluida', 36.00, 5, NULL);
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (10, NULL, 7, '2026-03-18', '09:00', '13:00', 'Concluida', 14.00, NULL, NULL);
GO
INSERT INTO reserva (cliente_id, sala_id, posto_id, data_reserva, hora_inicio, hora_fim, estado, valor, num_participantes, notas)
VALUES (1, 1, NULL, '2026-03-20', '10:00', '12:00', 'Concluida', 30.00, 3, NULL);
GO

-- =====================================================================
-- Pagamentos
-- Adesão IDs: 1-13 = Ativas, 14-17 = Terminadas, 18-19 = Pendentes, 20 = Cancelada
-- Reserva IDs: ver ordem acima (1-34 aprox)
-- =====================================================================
...
GO
INSERT INTO pagamento (cliente_id, valor, metodo_pagamento, estado, adesao_id, reserva_id) VALUES (9,  50.00,  'Dinheiro',     'Pago',     7,  NULL);
GO
...
GO
INSERT INTO pagamento (cliente_id, valor, metodo_pagamento, estado, adesao_id, reserva_id) VALUES (2,  27.00,  'Dinheiro',     'Pago', NULL, 19);
GO
